                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="w-full">
                                ...
                                <FormDescription>Details of the income</FormDescription>
                                <FormMessage/>
                            </FormItem>
                        )}
                    />
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="mb-4">
                            ...
                            <FormDescription>Income amount</FormDescription>
                            <FormMessage/>
                        </FormItem>
                    )}
                />
                    ...
                    render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-2 space-y-0 rounded-md border p-4 shadow">
                            ...
                            <div className="space-y-1 leading-none">
                                ...
                                <FormDescription>Mark this income as paid</FormDescription>
                                <FormMessage/>
                            </div>
                        </FormItem>
                    )}
